...
class ReplayType(Enum):
    No_replay = 'No replay'
    MF_backward_replay = 'MF - Backward replay'
    MF_shuffled_replay = 'MF - Shuffled replay'
    MB_prioritized_sweeping_replay = 'MB - Prioritized sweeping replay'
...
epsilon_p = 0.001  # 0.001 # threshold above which a cumulated change in Q-values requires another cycle of replay
